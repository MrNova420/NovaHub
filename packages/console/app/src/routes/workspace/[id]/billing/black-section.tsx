...
import { Database, eq, and, isNull, sql } from "@novahub/console-core/drizzle/index.js"
import { BillingTable, SubscriptionTable } from "@novahub/console-core/schema/billing.sql.js"
import { Actor } from "@novahub/console-core/actor.js"
import { Black } from "@novahub/console-core/black.js"
          ...
          <section class={styles.root}>
            <div data-slot="section-title">
              ...
              <div data-slot="title-row">
                <p>You are subscribed to NovaHub Black for ${sub().plan} per month.</p>
                <button
                  data-color="primary"
            ...
            <div data-slot="title-row">
              <p>
                {billing()?.timeSubscriptionSelected
                  ? `We're ready to enroll you into the $${billing()?.subscriptionPlan} per month NovaHub Black plan.`
                  : `You are on the waitlist for the $${billing()?.subscriptionPlan} per month NovaHub Black plan.`}
              </p>
              <button
                data-color="danger"
