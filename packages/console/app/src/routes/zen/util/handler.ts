...
import { and, Database, eq, isNull, lt, or, sql } from "@novahub/console-core/drizzle/index.js"
import { KeyTable } from "@novahub/console-core/schema/key.sql.js"
import { BillingTable, SubscriptionTable, UsageTable } from "@novahub/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@novahub/console-core/util/price.js"
import { getWeekBounds } from "@novahub/console-core/util/date.js"
import { Identifier } from "@novahub/console-core/identifier.js"
import { Billing } from "@novahub/console-core/billing.js"
import { Actor } from "@novahub/console-core/actor.js"
import { WorkspaceTable } from "@novahub/console-core/schema/workspace.sql.js"
import { ZenData } from "@novahub/console-core/model.js"
import { Black, BlackData } from "@novahub/console-core/black.js"
import { UserTable } from "@novahub/console-core/schema/user.sql.js"
import { ModelTable } from "@novahub/console-core/schema/model.sql.js"
import { ProviderTable } from "@novahub/console-core/schema/provider.sql.js"
...
export async function handler(
  ...
  const FREE_WORKSPACES = [
    ...
    "wrk_01K6W1A3VE0KMNVSCQT43BG2SX", // novahub bench
  ]
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-novahub-session") ?? ""
    const requestId = input.request.headers.get("x-novahub-request") ?? ""
    const projectId = input.request.headers.get("x-novahub-project") ?? ""
    const ocClient = input.request.headers.get("x-novahub-client") ?? ""
    logger.metric({
      is_tream: isStream,
      session: sessionId,
      request: requestId,
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetch(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-novahub-request")
          headers.delete("x-novahub-session")
          headers.delete("x-novahub-project")
          headers.delete("x-novahub-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo) {
    ...
    if (!billing.paymentMethodID)
      throw new CreditsError(
        `No payment method. Add a payment method here: https://novahub.ai/workspace/${authInfo.workspaceID}/billing`,
      )
    if (billing.balance <= 0)
      throw new CreditsError(
        `Insufficient balance. Manage your billing here: https://novahub.ai/workspace/${authInfo.workspaceID}/billing`,
      )
    ...
    if (
      ...
      throw new MonthlyLimitError(
        `Your workspace has reached its monthly spending limit of $${billing.monthlyLimit}. Manage your limits here: https://novahub.ai/workspace/${authInfo.workspaceID}/billing`,
      )
    ...
    if (
      ...
      throw new UserLimitError(
        `You have reached your monthly spending limit of $${authInfo.user.monthlyLimit}. Manage your limits here: https://novahub.ai/workspace/${authInfo.workspaceID}/members`,
      )
