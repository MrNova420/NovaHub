export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af NovaHub",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i NovaHub.",
  ...
  "provider.connect.novahubZen.line1":
    "NovaHub Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.novahubZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.novahubZen.visit.prefix": "Besøg ",
  "provider.connect.novahubZen.visit.link": "novahub.ai/zen",
  "provider.connect.novahubZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i NovaHub.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i NovaHub.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i novahub.json",
  ...
  "dialog.server.description": "Skift hvilken NovaHub-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af NovaHub ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til NovaHub-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (novahub.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, NovaHub understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "NovaHub inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for NovaHub",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan NovaHub ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan NovaHub er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når NovaHub starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af NovaHub.",
