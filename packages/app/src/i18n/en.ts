export const dict = {
  ...
  "dialog.provider.novahub.note": "Curated models including Claude, GPT, Gemini and more",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by NovaHub",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in NovaHub.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.novahubZen.line1":
    "NovaHub Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.novahubZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.novahubZen.visit.prefix": "Visit ",
  "provider.connect.novahubZen.visit.link": "novahub.ai/zen",
  "provider.connect.novahubZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in NovaHub.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in NovaHub.",
  ...
  "dialog.plugins.empty": "Plugins configured in novahub.json",
  ...
  "dialog.server.description": "Switch which NovaHub server this app connects to.",
  ...
  "toast.update.description": "A new version of NovaHub ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the NovaHub team",
  ...
  "error.chain.checkConfig": "Check your config (novahub.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, NovaHub does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "NovaHub includes free models so you can start immediately.",
  ...
  "settings.general.row.language.description": "Change the display language for NovaHub",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how NovaHub looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how NovaHub is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when NovaHub launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of NovaHub.",
