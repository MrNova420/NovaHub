export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez NovaHub",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w NovaHub.",
  ...
  "provider.connect.novahubZen.line1":
    "NovaHub Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.novahubZen.visit.prefix": "Odwiedź ",
  "provider.connect.novahubZen.visit.link": "novahub.ai/zen",
  "provider.connect.novahubZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w NovaHub.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w NovaHub.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w novahub.json",
  ...
  "dialog.server.description": "Przełącz serwer NovaHub, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja NovaHub ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu NovaHub",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (novahub.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    'Serwer MCP "{{name}}" nie powiódł się. Uwaga, NovaHub nie obsługuje jeszcze uwierzytelniania MCP.',
  ...
  "sidebar.gettingStarted.line1": "NovaHub zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla NovaHub",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd NovaHub na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw NovaHub.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania NovaHub",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji NovaHub.",
