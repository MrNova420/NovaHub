...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von NovaHub",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in NovaHub zu nutzen.",
  ...
  "provider.connect.novahubZen.line1":
    "NovaHub Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  "provider.connect.novahubZen.line2":
    "Mit einem einzigen API-Schlüssel erhalten Sie Zugriff auf Modelle wie Claude, GPT, Gemini, GLM und mehr.",
  "provider.connect.novahubZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.novahubZen.visit.link": "novahub.ai/zen",
  "provider.connect.novahubZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in NovaHub zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in NovaHub zu nutzen.",
  ...
  "dialog.plugins.empty": "In novahub.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den NovaHub-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von NovaHub ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem NovaHub-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (novahub.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: NovaHub unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "NovaHub enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "NovaHub Desktop",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für NovaHub ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie NovaHub auf Ihrem Gerät aussieht",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von NovaHub anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von NovaHub automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von NovaHub.",
