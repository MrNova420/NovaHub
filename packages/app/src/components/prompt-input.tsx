import { useFilteredList } from "@novahub/ui/hooks"
import {
  createEffect,
  on,
  Component,
...
import { FileIcon } from "@novahub/ui/file-icon"
...
import { Select } from "@novahub/ui/select"
import { getDirectory, getFilename, getFilenameTruncated } from "@novahub/util/path"
import { useDialog } from "@novahub/ui/context/dialog"
import { ImagePreview } from "@novahub/ui/image-preview"
...
import { createOpencodeClient, type Message, type Part } from "@novahub/sdk/v2/client"
