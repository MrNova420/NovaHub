...
import { resolveThemeVariant, useTheme, withAlpha, type HexColor } from "@novahub/ui/theme"
...
export const Terminal = (props: TerminalProps) => {
  ...
  onMount(() => {
    const run = async () => {
      ...
      if (window.__NOVAHUB__?.serverPassword) {
        url.username = "novahub"
        url.password = window.__NOVAHUB__?.serverPassword
      }
