...
Create `.novahub/commands/test.md`:

```md title=".novahub/commands/test.md"
---
...
You can add custom commands through the NovaHub config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your NovaHub [config](/docs/config):

```json title="novahub.jsonc" {4-12}
{
...
- Global: `~/.config/novahub/commands/`
- Per-project: `.novahub/commands/`

```markdown title="~/.config/novahub/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".novahub/commands/component.md"
---
...
```md title=".novahub/commands/create-file.md"
---
...
```md title=".novahub/commands/analyze-coverage.md"
---
...
```md title=".novahub/commands/review-changes.md"
---
...
```md title=".novahub/commands/review-component.md"
---
...
novahub includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
