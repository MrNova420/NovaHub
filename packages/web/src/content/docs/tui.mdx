---
title: TUI
description: Using the NovaHub terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

NovaHub provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running NovaHub starts the TUI for the current directory.
...
When using the NovaHub TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to NovaHub. Allows you to select from available providers and add their API keys.
...
You can customize TUI behavior through your NovaHub config file.
