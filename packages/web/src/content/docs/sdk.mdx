---
title: SDK
description: Type-safe JS client for novahub server.
---

import config from "../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

The novahub JS/TS SDK provides a type-safe client for interacting with the server.
Use it to build integrations and control novahub programmatically.
...
You can pass a configuration object to customize behavior. The instance still picks up your `novahub.json`, but you can override or add configuration inline:
...
console.log(`Server running at ${novahub.server.url}`)
...
If you already have a running instance of novahub, you can create a client instance to connect to it:
...
```typescript
import type { Session, Message, Part } from "@novahub/sdk"
```
...
const textResults = await client.find.text({
  query: { pattern: "function.*novahub" },
})
