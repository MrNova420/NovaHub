export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af NovaHub",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af NovaHub er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge 'novahub'-kommandoen.",
  ...
  "desktop.error.serverStartFailed.description":
    "Den lokale NovaHub-server kunne ikke startes. Genstart appen, eller tjek dine netværksindstillinger (VPN/proxy) og prøv igen.",
}
