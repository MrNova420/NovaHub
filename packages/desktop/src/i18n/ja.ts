export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの NovaHub を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "NovaHub のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'novahub' コマンドを使用してください。",
  "desktop.cli.failed.title": "インストールに失敗しました",
  "desktop.cli.failed.message": "CLI のインストールに失敗しました: {{error}}",

  "desktop.error.serverStartFailed.title": "NovaHub の起動に失敗しました",
  "desktop.error.serverStartFailed.description":
    "ローカルの NovaHub サーバーを起動できませんでした。アプリを再起動するか、ネットワーク設定 (VPN/proxy) を確認して再試行してください。",
}
