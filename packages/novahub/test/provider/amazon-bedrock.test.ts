...
const mockPlugin = () => ({})
mock.module("novahub-copilot-auth", () => ({ default: mockPlugin }))
mock.module("novahub-anthropic-auth", () => ({ default: mockPlugin }))
mock.module("@gitlab/novahub-gitlab-auth", () => ({ default: mockPlugin }))
