...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/novahub.git")).toEqual({ owner: "sst", repo: "novahub" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/novahub")).toEqual({ owner: "sst", repo: "novahub" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/novahub.git")).toEqual({ owner: "sst", repo: "novahub" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/novahub")).toEqual({ owner: "sst", repo: "novahub" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/novahub.git")).toEqual({ owner: "sst", repo: "novahub" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/novahub")).toEqual({ owner: "sst", repo: "novahub" })
})
