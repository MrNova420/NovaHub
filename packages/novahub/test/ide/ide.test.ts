...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders NOVAHUB_CALLER", () => {
    process.env["NOVAHUB_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode NOVAHUB_CALLER", () => {
    process.env["NOVAHUB_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown NOVAHUB_CALLER", () => {
    process.env["NOVAHUB_CALLER"] = "unknown"
