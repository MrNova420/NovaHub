...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/novahub/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/novahub...\n")
...
console.log("Fetching npm all-time downloads for novahub...\n")
const npmDownloads = await fetchNpmDownloads("novahub")
